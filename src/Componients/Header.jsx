...
import { FaUser, FaHome, FaStore, FaPlus, FaSignOutAlt } from 'react-icons/fa'; // Import necessary icons
            ...
            <div className="flex items-center space-x-4">
                ...
                {!loggedInUser ? (
                    ...
                    <div className="relative flex items-center gap-3">
                        ...
                        <p className="font-semibold text-gray-700 border-r border-gray-500 px-4">
                            <span className="text-black">{loggedInUser.teacher}</span>
                        </p>
                        <LanguageSwitcher />
                        <Link
                            ref={userInfoRef}
