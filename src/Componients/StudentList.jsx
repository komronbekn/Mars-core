...
const StudentList = () => {
    ...
    const fetchStudentsAndGroupCoins = async (teacherId) => {
        try {
            ...
            setGroupCoins(600);
            console.log(teacherData.groupId.coins);
                    ...
                    <table className="w-full overflow-hidden">
                        <thead>
                            <tr className="text-black bg-gray-100 uppercase w-full text-sm leading-normal">
                                <th className="py-4 px-6 w-36 text-left shadow-r-gray">{t('students')}</th>
                                <th className="py-4 px-6 text-left">{t('League')}</th>
                                <th className="py-4 px-6 text-left">{t('coins')}</th>
